...
> Design notes for **media-ops-doc-qa** — a runnable python example that A FastAPI service that answers questions over a streaming team's ingest, processing and delivery runbooks, and escalates when retrieval is weak.
...
- **Feature code** — the actual task: document question answering.
